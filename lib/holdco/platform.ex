defmodule Holdco.Platform do
  ...
  def seed_default_actions do
    defaults = [
      ...
      %{name: "Tax", description: "Tax provisions and capital gains", action_type: "navigate", target_path: "/tax", icon: "receipt", category: "tax", search_keywords: ["provision", "tax liability", "capital gains"], sort_order: 6},
      %{name: "Anomalies", description: "Fraud detection & anomalies", action_type: "navigate", target_path: "/anomalies", icon: "shield-alert", category: "risk", search_keywords: ["exposure", "fraud", "anomaly"], sort_order: 7},
