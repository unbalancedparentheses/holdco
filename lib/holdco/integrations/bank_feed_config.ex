defmodule Holdco.Integrations.BankFeedConfig do
  ...
  schema "bank_feed_configs" do
    ...
    has_many :feed_transactions, Holdco.Integrations.BankFeedTransaction, foreign_key: :feed_config_id
  ...
  def changeset(bank_feed_config, attrs) do
    bank_feed_config
    |> cast(attrs, [:company_id, :bank_account_id, :provider, :external_account_id,
                     :access_token, :is_active, :last_sync_at, :notes])
