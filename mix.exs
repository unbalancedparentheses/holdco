defmodule Holdco.MixProject do
  use Mix.Project
  ...
  defp aliases do
    [
      ...
      "ecto.setup": ["ecto.create", "ecto.migrate"] ++ if(Mix.env() != :test, do: ["run priv/repo/seeds.exs"], else: []),
      "ecto.reset": ["ecto.drop", "ecto.setup"],
      test: ["ecto.create --quiet", "ecto.migrate --quiet", "test"],
      "assets.setup": ["tailwind.install --if-missing", "esbuild.install --if-missing"],
      "assets.build": ["compile", "tailwind holdco", "esbuild holdco"],
      "assets.deploy": [
        "tailwind holdco --minify",
